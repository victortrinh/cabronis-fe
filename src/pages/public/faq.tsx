...
const Faq = () => {
  ...
  return (
    <Container $isMobile={isMobile}>
      ...
      <div className="sub-subtitle">{t("for-pokemon")}</div>
      <div className="information">{t("shipping-information-pokemon")}</div>
      <table>
        <tr>
          <th>{t("type")}</th>
          <th>{t("price")}</th>
      ...
      <div className="sub-subtitle">{t("for-sports")}</div>
      <div className="information">{t("shipping-information-sports")}</div>
      <table>
        <tr>
          <th>{t("type")}</th>
          <th>{t("price")}</th>
